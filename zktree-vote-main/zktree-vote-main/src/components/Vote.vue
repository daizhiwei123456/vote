...
//投票者使用 Vote 组件进行投票。
//它使用 zk-merkle-tree 中的 calculateMerkleRootAndZKProof 方法生成 ZK 证明，
//并使用 nullifier 将其发送到区块链。
    ...
    const abi = [
      "function vote(uint _option,uint256 _nullifier,uint256 _root,uint[emory _proof_a,uint[2][2] memory _proof_b,uint[2] memory _proof_c)",
    ];2] m
